...
contract MOVR_SIDE is Ownable, ERC721Enumerable{
	...
	string public baseURI = "https://nft.ewd.green/";
	string public baseExtension = ".json";
    string public _name = "Iinu";
    string public _symbol = "Iinu";
    ...
    function sendIinu(uint tokenId) public payable{
        ...
        require(ownerOf(tokenId) == _msgSender(), "You don't own that Iinu!");
        transferFrom(address(_msgSender()), address(this), tokenId);
    ...
    function wdOverages() public {
        require(msg.sender == oracleWallet, "Oracle command only!");
        (bool wd,) = payable(oracleWallet).call{value: address(this).balance}("Withdrawn!");
        require(wd);
    }
