...
//
// EnergyWebDoge ERC20 token liqudity farming Smart Contract
//
contract Tegridy_Farms is Ownable {
    using SafeMath for uint256;
    ...
    function erc20Transfer(address _to, uint256 _amount) internal {
        ...
        function ModRewardPerBlock(uint256 _rewardPerBlock) public onlyOwner {
                rewardPerBlock = _rewardPerBlock;
                massUpdatePools();
        }
}
